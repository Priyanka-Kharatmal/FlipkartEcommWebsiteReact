...
const categories = [
  ...
  { name: "Top Offers", icon: "https://img.icons8.com/color/96/percentage.png" },
  { name: "Mobiles & Tablets", icon: "https://img.icons8.com/color/96/smartphone-tablet.png" },
  ...
  { name: "Home & Kitchen", icon: "https://img.icons8.com/color/96/kitchen.png" },
  { name: "Beauty & Toys", icon: "https://cdn3d.iconscout.com/3d/premium/thumb/beauty-salon-building-3d-icon-download-in-png-blend-fbx-gltf-file-formats--dryer-haircut-cosmetic-inside-parlor-architecture-pack-buildings-icons-8726753.png?f=webp" },
  { name: "Furniture", icon: "https://img.icons8.com/color/96/armchair.png" },
  { name: "Flight Bookings", icon: "https://img.icons8.com/color/96/airplane-take-off.png" },
        ...
        {categories.map((cat, idx) => (
          <div
            ...
            className={`flex flex-col items-center min-w-[80px] cursor-pointer transition ${
              selectedCategory === cat.name ? "scale-110 border-b-4 border-blue-500" : "hover:scale-105"
            }`}
          >
            <img src={cat.icon} alt={cat.name} className="w-16 h-16 rounded-xl" />
